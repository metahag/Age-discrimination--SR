...
(bs_plot <- forest(all_rma, xlim=c(-16, 8), at=log(c(0.25, 1, 4)), atransf=exp,
       ...
       ilab.xpos=c(-7.6,-6,-4,-2.5,3), cex=0.7, 
       ylim=c(-1, 27),
       #order = "obs",
...
text(c(-8.1,-6,-3.75,-1.7), 27, c("Not invited", "Invited", "Not invited", "Invited"))
text(c(-6.8,-3),        26,                c("Control",                "Older"))
...
text(-6,               9, "Callbacks")
text(c(-9.2,-6.5,-4,-2.5), 8.5, c("Control only", "Older only", "Both", "Neither"))
